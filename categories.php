...
<html lang="en">
    <head>
        ...
        <script src="script/sort_products.js" type="text/javascript"></script>
    </head>

    <body onload="ajaxPagination(<?php echo $admin ?>)">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="home_content">
                                        <div class="home_title">Glichie Products<span>.</span></div>
                                        <div class="home_text"><p>Relax and browse, we know you'll find something you love!</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
                                <div class="results"><span></span></div>
