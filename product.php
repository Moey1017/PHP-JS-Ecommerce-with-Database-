...
<html lang="en">
    <head>
        ...
        <script src="script/get_a_product.js" type="text/javascript"></script>
        <script src="script/add_to_cart.js" type="text/javascript"></script>
        <script src="script/load_new_products.js" type="text/javascript"></script>
    </head>
    
    <body onload=ajaxGetProduct(),ajaxNewProducts(<?php echo $admin ?>)>
                                    ...
                                    <div class="header_extra ml-auto">
                                        <div class="shopping_cart">
                                            <a href="cart.php">
                                                ...
                                                <div>Cart<span id="number_in_cart"></span></div>
                                            </a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="home_content">
                                        <div class="home_title"><div class="title_holder"></div></div>
                    ...
                    <div class="row details_row">
                        ...
                        <div class="col-lg-6">
                            <div class="details_image">
                                <div class="details_image_large"><div class="product_extra product_new"><a href="categories.html">New</a></div></div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="details_content">
                                ...
                                <div class="product_quantity_container">
                                    ...
                                    <?php
                                    if (!isset($user_id)) {
                                        echo '<div class="button cart_button"><a href="login.php">Login</a></div>';
                                    } else {
                                        echo '<div class="button cart_button"><a onclick="ajaxAddToCart();
                                            return false;">Add to Cart</a></div>';
                                    }
                                    ?>
