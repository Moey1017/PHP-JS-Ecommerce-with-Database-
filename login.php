                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="home_content">
                                        ...
                                        <div class="home_text"><p>Hey! Just login to start adding items to cart and make some amazing purchases!</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 contact_col">
                            <div class="get_in_touch">
                                <div class="section_title">Please enter Username and Password</div>
                                <div class="contact_form_container">
                                    <form action="php/login_transaction.php" method="post" id="contact_form" class="contact_form">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <!-- Name -->
                                                
                                                <label for="contact_name">User Name*</label>
                                                <input type="text" id="contact_name" name="email" class="contact_input" required="required">
                                            </div>
                                            <div class="col-xl-6 last_name_col">
                                                <!-- Last Name -->
                                                <label for="contact_last_name">Password*</label>
                                                <input type="password" id="contact_last_name" name="password" class="contact_input" required="required">
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-12 contact_col">
                            <div class="get_in_touch">
                                ...
                                <div class="contact_form_container">
                                    <form action="php/register_new_user_transaction.php" id="contact_form" class="contact_form" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <label for="name">Name*</label>
                                                <input type="text" id="name" name = "name" class="contact_input" required="required" autofocus>
                                            </div>
                                            <div class="col-xl-6">
                                                <label for="Email">Email*</label>
                                                <input type="text" id="email" name = "email" class="contact_input" required="required" autofocus>
                                            </div>
                                            <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="password" id="confirmPassword" name = "confirmPassword" class="contact_input" required="required">
                                            </div>
                                        </div>
                                        <button type="submit" value="Register New User "class="button contact_button"><span>Register</span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
