                    ...
                    <div class="row pt-4 pb-4">
                        <div class="col-md-6 mx-auto">
                            <div class="progress-card mb-4">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped stars progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 25%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 contact_col">
                            <div class="get_in_touch">
                                <div class="section_title">Are Theses Details Correct?</div>
                                <div class="contact_form_container">
                                    <form action="confirm_details.php" id="contact_form" class="contact_form" method="POST">
                                        <div>
                                            <label for="name">Name</label>
                                            <input name="name" type="text" id="user_name" class="contact_input">
                                        </div>
                                        <div>
                                            <!-- Subject -->
                                            <label for="email">Email</label>
                                            <input name="email" type="text" id="user_email" class="contact_input">
                                        </div>
                                        <div>
                                            <!-- Subject -->
                                            <label for="paymentAmount">Order Amount</label>
                                            <input name="paymentAmount" type="text" id="order_amount" class="contact_input" readonly>
                                        </div>
                                        <div>
                                            <!-- Subject -->
                                            <label for="cartQuantity">Cart Quantity</label>
                                            <input name="cartQuantity" type="text" id="cart_quantity" class="contact_input">
                                        </div>
                                        <button type="submit" class="button contact_button"><span>Continue</span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
