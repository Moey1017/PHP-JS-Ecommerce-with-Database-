...
<html lang="en">
    <head>
        ...
        <script src="script/update_products.js" type="text/javascript"></script>
    </head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 contact_col">
                            <div class="get_in_touch">
                                <div class="section_title">Edit The Products Details</div>
                                <div class="contact_form_container">
                                    <form action="php/update_product_transaction.php" id="contact_form" class="contact_form" method="POST">
                                        <div>
